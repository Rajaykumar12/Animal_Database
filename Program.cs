...
do
{
    ...
    Console.WriteLine("Enter the ID of the animal whose age you want to update:");
    readResult = Console.ReadLine();
    if (readResult != null)
    {
        string idToUpdate = readResult.ToLower();
        bool found = false;

        for (int i = 0; i < maxPets; i++)
        {
            if (ourAnimals[i, 0].ToLower().Contains(idToUpdate))
            {
                found = true;
                do
                {
...
case "6":
    ...
    Console.WriteLine("Enter the ID of the animal whose personality description you want to update:");
    readResult = Console.ReadLine();
    if (readResult != null)
    {
        string idToUpdate = readResult.ToLower();
        ...
        for (int i = 0; i < maxPets; i++)
        {
            ...
            {
                found = true;
                Console.WriteLine($"Enter the new personality description for {ourAnimals[i, 0]}:");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
...
case "7":
    ...
    Console.WriteLine("Enter a keyword to search for cats with a specific characteristic:");
    readResult = Console.ReadLine();
    if (readResult != null)
    {
        string keyword = readResult.ToLower();
        bool found = false;

        for (int i = 0; i < maxPets; i++)
        {
            if (ourAnimals[i, 1].ToLower().Contains("cat") && 
                (ourAnimals[i, 3].ToLower().Contains(keyword) || ourAnimals[i, 5].ToLower().Contains(keyword)))
            {
                found = true;
                Console.WriteLine();
                for (int j = 0; j < 6; j++)
...
case "8":
    ...
    Console.WriteLine("Enter a keyword to search for dogs with a specific characteristic:");
    readResult = Console.ReadLine();
    if (readResult != null)
    {
        string keyword = readResult.ToLower();
